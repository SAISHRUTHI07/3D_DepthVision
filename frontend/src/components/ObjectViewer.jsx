...
const TYPE_COPY = {
  ...
  scene: { title: '3D Image / Scene Reconstruction', subject: 'image or scene', single: 'A depth-based spatial visible-surface mesh is created from the supplied image without assuming its camera angle.' },
}
...
export default function ObjectViewer({ fileId, uploadedFile, depthResult, objectData, mode = 'object', inputViews = {}, onObjectLoaded, onSave, canSave }) {
